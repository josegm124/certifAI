...
export default function Register() {
  ...
  return <main className="wrap"><form className="card" style={{ maxWidth: 620, margin: "0 auto" }} onSubmit={submit}>
    ...
    <div className="field"><label className="lbl">Password</label><input className="input" type="password" minLength={8} required value={form.password} onChange={field("password")} /><div className="sec-note" style={{ marginTop: 6 }}>At least 8 characters.</div></div>
