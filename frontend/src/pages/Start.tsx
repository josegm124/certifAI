...
export default function Start() {
  ...
  return <main className="wrap wrap-wide">
    ...
    <section className="pricing">
      ...
      <Tier name="Evidence & Badge" tag="Tier 2 · Demo" points={["Evidence references per control", "Signed self-certification", "Evidence reviewed against each control. AI-assisted review is in development; the current release records evidence without automated review.", "Eligible for a public badge"]} action="Start Tier 2" onClick={() => start(2)} disabled={!aiSystemName.trim() || busy} accent />
    </section>
