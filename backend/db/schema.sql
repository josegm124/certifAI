...
CREATE TABLE IF NOT EXISTS assessments (
  ...
  badge_tier TEXT CHECK(badge_tier IN ('aware', 'aligned', 'assured', 'advanced')) DEFAULT 'aware',
  critical_gating_active BOOLEAN DEFAULT 0,
  self_certified BOOLEAN DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS badges (
  ...
  assessment_id TEXT NOT NULL,
  company_id TEXT NOT NULL,
  tier TEXT CHECK(tier IN ('aware', 'aligned', 'assured', 'advanced')) NOT NULL,
  score REAL NOT NULL,
